...
// Shared chrome for the /prior demo section: header + section tabs.

const TABS = [
  { to: '/prior', label: 'Overview', end: true },
  { to: '/prior/simulate', label: 'Case Simulation', end: false },
]

export function PriorLayout({ children }: { children: ReactNode }) {
  return (
